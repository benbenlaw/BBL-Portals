...
import com.benbenlaw.portals.util.ShouldTeleport;
...
//        }
        ...
        public PortalMaker beforeTeleportation(Function<Entity, ShouldTeleport> entity) {
        ...
        public PortalMaker inPortalAmbienceSound(SoundEvent event, float pitch, float volume) {
            this.builder.registerInPortalAmbienceSound(player -> new PortalSoundEvent(event, pitch, volume));
            return this;
        }
        ...
        public PortalMaker afterTeleportationAmbienceSound(SoundEvent event, float pitch, float volume) {
            this.builder.registerPostTPPortalAmbience(player -> new PortalSoundEvent(event, pitch, volume));
            return this;
        }
